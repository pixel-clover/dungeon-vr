...
export class Settings {
  constructor(audio, player, callbacks = {}) {
    this.audio = audio;
    this.player = player;
  ...
  bindUI() {
    ...
    const difficultyEl = document.getElementById('setting-difficulty');
    ...
    difficultyEl.value = this.values.difficulty;
    qualityEl.value = this.values.quality;
    ...
    difficultyEl.addEventListener('change', () => {
      this.set('difficulty', difficultyEl.value);
    });
    qualityEl.addEventListener('change', () => {
      this.set('quality', qualityEl.value);
    });
