...
const ENEMY_DEFS = [
    { name: 'orc', url: 'assets/models/orc.glb', scale: 0.95, yOffset: 0, yawOffset: Math.PI },
    { name: 'goleling', url: 'assets/models/goleling.glb', scale: 1.05, yOffset: 0, yawOffset: Math.PI },
    { name: 'demon', url: 'assets/models/demon.glb', scale: 0.85, yOffset: 0, yawOffset: Math.PI },
];
